        ...
        <>
            ...
            <Layout site={site}>
                <Layout.Main>
                    ...
                    <p>Welcome to our website! These terms of service (the &#34;Terms&#34;) govern your use of our website located at [insert website URL] (the &#34;Website&#34;), which is owned and operated by [insert company name] (&#34;we&#34;, &#34;us&#34;, or &#34;our&#34;).</p>
                    ...
                    <p>Content on the Website: The content on the Website, including text, images, videos, and other materials (the &#34;Content&#34;), is for informational purposes only. We make no representations or warranties regarding the accuracy, completeness, or reliability of the Content.</p>

                    <p>User Content: We may allow users to submit content, such as comments or blog posts, to the Website (the &#34;User Content&#34;). By submitting User Content, you grant us a non-exclusive, transferable, sub-licensable, royalty-free, worldwide license to use, copy, modify, create derivative works based on, distribute, publicly display, publicly perform, and otherwise exploit in any manner such User Content in all formats and distribution channels now known or hereafter devised (including in connection with the Website and our business and on third-party sites and services), without further notice to or consent from you, and without the requirement of payment to you or any other person or entity.</p>
